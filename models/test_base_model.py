...
class TestBaseModel(unittest.TestCase):
    ...
    def test_init(self, mockstorage):
        ...
        self.assertEqual(self.model.created_at, self.model.updated at)
    ...
    def test_str(self):
        """Test __str__ method"""
        expected str - f"[BaseModel] ({self.model.id}) {self.model.__dict__}"
    ...
    def test_save(self, mock_storage):
        ...
        self.assertTrue(self.modelupdated_at > old_updated_at)
